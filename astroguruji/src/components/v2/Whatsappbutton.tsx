 ...
 * WhatsAppButton.tsx
 *
 * Fixed floating WhatsApp button — visible on every page.
 * Mount once inside App.tsx (outside <Routes>) so it persists across navigation.
 */

const WHATSAPP_NUMBER = "918881110523"; // country code + number, no +
