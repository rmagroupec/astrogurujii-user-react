...
export default function ServicePill({ label, icon, color }: ServicePillProps) {
  return (
    <div className="flex w-fit items-center gap-2 rounded-full border border-gray-200 bg-white px-3 py-[8px] shadow-sm md:gap-3 md:px-5 md:py-[10px]">
      <div
